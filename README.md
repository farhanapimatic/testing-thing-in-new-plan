...
![Add a new project in PyCharm - Step 4](https://apidocs.io/illustration/python?step=projectFiles&workspaceFolder=Swagger%20Petstore-Python&libraryName=swaggerpetstore.swaggerpetstore_client&projectName=swaggerpetstore&className=SwaggerpetstoreClient)
...
![Run Test Project - Step 1](https://apidocs.io/illustration/python?step=runProject&workspaceFolder=Swagger%20Petstore-Python&libraryName=swaggerpetstore.swaggerpetstore_client&projectName=swaggerpetstore&className=SwaggerpetstoreClient)
